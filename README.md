...
`devcull` safely hunts down and removes massive, forgotten cache directories left behind by IDEs, package managers, and toolchains. It features a concurrent Go execution engine and a language-agnostic JSON-RPC plugin system, allowing anyone to extend it.
...
- **Extensible Architecture:** Write custom cleaners in _any_ language (TypeScript, Bash, Python, Go) using standard JSON-RPC subprocess API.
